...
#define AHT20_I2C_SDA_PIN_G AHT_SDA_GPIO_Port
#define AHT20_I2C_SDA_PIN AHT_SDA_Pin
#define AHT20_I2C_SCL_PIN_G AHT_SCL_GPIO_Port
#define AHT20_I2C_SCL_PIN AHT_SCL_Pin
